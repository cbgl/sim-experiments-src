...
class Utils
{
  public:
    ...
    static double caer(
      const std::vector<double>& sr, const std::vector<double>& sv);
    ...
    static std::pair<double,double> fitPoints(const std::vector<double>& pts);
    ...
    static void obelix(std::vector<double>* scan, const double& ang_min);
    ...
    static std::vector<double> unwrap(const std::vector<double>& in_vec);

    static std::vector<double> vectorDiff(const std::vector<double>& vec);
