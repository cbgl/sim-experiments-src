...
class S2MSM
{
  ...
  private:
    ...
    std::string area_filename_;
    std::string hr_dist_filename_;
    ...
    void fanoutHypothesesSemicolonGetCAERs(
      const std::vector<double>& real_scan,
      const std::vector< std::pair<double,double> > map,
      const std::vector< std::tuple<double,double,double> >& hypotheses,
      std::vector< std::tuple<double,double,double> >* all_hypotheses,
    ...
    void generateMapConfiguration(
      ...
      std::vector< std::tuple<double,double,double> >* hypotheses);
